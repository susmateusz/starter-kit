...
insert into library (id, name) values (16, 'Biblioteka Miejska');
...
insert into book (id, title, library_id) values (4, 'Dwunasta książka',14);
insert into book (id, title, library_id) values (5, 'Piętnasta książka',16);
insert into book (id, title, library_id) values (6, 'Trzynasta książka',16);
